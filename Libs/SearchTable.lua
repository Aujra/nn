...
EditBox Widget
-------------------------------------------------------------------------------]]
function _iter_props(obj)
    for k,v in pairs(obj) do
        print("k: " .. k .. " v: " .. type(v))
    end
end

local Type, Version = "SearchTable", 28
local AceGUI = tt.nn.Utils.LibStub and tt.nn.Utils.AceGUI
local ScrollTableLib = tt.nn.Utils.LibStub("ScrollingTable")
...
local function Constructor(params)
    ...
    local widget = {
        alignoffset = 30,
        frame       = ScrollTableInstance.frame,
        type        = Type,
        scrollInstance = ScrollTableInstance
    }
